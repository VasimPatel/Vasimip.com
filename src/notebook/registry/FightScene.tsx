  ...
  return (
    <svg viewBox="0 0 500 340" width="500" height="340" style={{ position: 'absolute', left: 0, top: 0, overflow: 'visible', pointerEvents: 'none' }}>
      ...
      <g transform="translate(88,300)">
        <g style={{ transformBox: 'fill-box', transformOrigin: '50% 100%', animation: 'duelistlunge 3.2s ease-in-out infinite' }}>
          <Attacker />
        </g>
      </g>
      ...
      <g transform="translate(34,304)">
        <g style={{ transformBox: 'fill-box', transformOrigin: '50% 100%', animation: 'queuecharge 3.2s ease-in-out infinite' }}>
          <Attacker scale={0.92} hideSword />
          {/* held sword — vanishes at the 70% disarm (the loose one takes over) */}
          <g style={{ animation: 'heldsword 3.2s linear infinite' }}>
        ...
        <g style={{ transformBox: 'fill-box', transformOrigin: '50% 50%', animation: 'loosesword 3.2s ease-in infinite', opacity: 0 }}>
      ...
      <g style={{ transformBox: 'fill-box', transformOrigin: '50% 50%', animation: 'clanga 3.2s linear infinite', opacity: 0 }}>
      ...
      <g style={{ transformBox: 'fill-box', transformOrigin: '50% 50%', animation: 'clangb 3.2s linear infinite', opacity: 0 }}>
      ...
      <path d="M150,268 q-18,10 -22,30" fill="none" stroke="#1a1a1a" strokeWidth="2" strokeLinecap="round" strokeDasharray="3 5" style={{ transformBox: 'fill-box', transformOrigin: '50% 50%', animation: 'clanga 3.2s linear infinite', opacity: 0 }} />
      <path d="M146,278 q-16,8 -19,26" fill="none" stroke="#1a1a1a" strokeWidth="2" strokeLinecap="round" strokeDasharray="3 5" style={{ transformBox: 'fill-box', transformOrigin: '50% 50%', animation: 'clangb 3.2s linear infinite', opacity: 0 }} />

      {/* charge speed-lines behind the queue attacker */}
      <g style={{ transformBox: 'fill-box', transformOrigin: '50% 50%', animation: 'chargelines 3.2s linear infinite', opacity: 0 }}>
